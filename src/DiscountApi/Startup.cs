...
namespace DiscountApi
{
    public class Startup
    {
        ...
        {
            services.AddCommandQuery(typeof(DiscountFramework.Discount).Assembly);

            services.AddSingleton(x => new MapperConfiguration(c => c.AddProfile<MappingSetup>()).CreateMapper());
